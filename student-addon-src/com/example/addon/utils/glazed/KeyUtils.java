...
public final class KeyUtils {
   public static CharSequence getKey(int key) {
      ...
      default:
         ...
         return (CharSequence)(keyName == null ? EncryptedString.of("None") : StringUtils.capitalize(keyName));
      }
   }

   public static boolean isKeyPressed(int n) {
      if (n <= 8) {
         return GLFW.glfwGetMouseButton(MeteorClient.mc.method_22683().method_4490(), n) == 1;
      } else {
         return GLFW.glfwGetKey(MeteorClient.mc.method_22683().method_4490(), n) == 1;
      }
   }
}
